      ...
      <div className="max-w-md w-full space-y-8">
        ...
        {resetSent && (
          <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
            <span className="block sm:inline">Password reset link has been sent to your email address. Please check your inbox.</span>
          </div>
        )}
        ...
        <div className="mt-4 flex items-center justify-center">
          ...
          <div className="mx-4 text-sm text-gray-500 dark:text-gray-400">Or continue with email</div>
          <div className="border-t border-gray-300 dark:border-gray-700 flex-grow"></div>
        </div>
